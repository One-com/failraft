...
module.exports = class Failraft extends Failboat {
  ...
  createReduxMiddleware(options) {
    if (this.middlewareCreated) {
      throw new Error("Cannot create multiple middleware instances.");
    }

    this.middlewareCreated = true;

    return createReduxMiddleware(this, options);
  }
